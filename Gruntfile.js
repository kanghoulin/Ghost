    ...
    configureGrunt = function (grunt) {
        ...
        var cfg = {
            ...
            clientFiles: [
				...
				'server/views/extend.hbs',
                'built/assets/ghost-user/ghost-user.js',
                'built/assets/ghost-user/ghost-user.css',
                'built/assets/ghost-user/vendor.js',
                'built/assets/ghost-user/vendor.css'
            ],
