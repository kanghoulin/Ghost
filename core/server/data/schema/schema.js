module.exports = {
	...
	comments: {
		id: {type: 'string', nullable: false, primary: true},
		post_slug: {type: 'string', maxlength: 150, nullable: false, index: true},
		user_id: {type: 'string', nullable: false, defaultTo: ''},
		user_name: {type: 'string', maxlength: 150, nullable: false, defaultTo: ''},
		user_face: {type: 'string', maxlength: 150, nullable: false, defaultTo: ''},
		comment: {type: 'string', maxlength: 1000, nullable: false, defaultTo: ''},
		comment_id: {type: 'string', nullable: false, defaultTo: ''},
		suser_name: {type: 'string', maxlength: 150, nullable: false, defaultTo: ''},
		like_num: {type: 'integer', nullable: false, unsigned: true, defaultTo: 0},
		created_at: {type: 'dateTime', nullable: false},
		updated_by: {type: 'string', nullable: false}
	},
	likes: {
		id: {type: 'string', nullable: false, primary: true},
		post_slug: {type: 'string', maxlength: 150, nullable: false, index: true},
