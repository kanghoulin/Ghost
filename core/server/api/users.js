...
users = {
    ...
    add: function add(object, options) {
        ...
        function modelQuery(options) {
            return dataProvider.User.add(options.data.users[0], _.omit(options, ['data']));
        }
        ...
        return pipeline(tasks, object, options).then(function formatResponse(result) {
            ...
            return Promise.reject(new errors.NotFoundError({message: i18n.t('errors.api.users.userErrCreate')}));
        });
    }
};
